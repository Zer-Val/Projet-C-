...
void testBSMCPricerEuropeanDigitalCallOption()
    {
        std::cout << " ---------------------------------------------------------------------------------" << std::endl;
        std::cout << "| Price with Black-Scholes Monte-Carlo pricer for an European Digital Call Option |" << std::endl;
        std::cout << " ---------------------------------------------------------------------------------" << std::endl;
...
void testBSMCPricerEuropeanDigitalPutOption()
    {
        std::cout << " --------------------------------------------------------------------------------" << std::endl;
        std::cout << "| Price with Black-Scholes Monte-Carlo pricer for an European Digital Put Option |" << std::endl;
        std::cout << " --------------------------------------------------------------------------------" << std::endl;
...
void testBSMCPricerAsianPutOption()
    {
        std::cout << " ---------------------------------------------------------------------" << std::endl;
        std::cout << "| Price with Black-Scholes Monte-Carlo pricer for an Asian Put Option |" << std::endl;
        std::cout << " ---------------------------------------------------------------------" << std::endl;
        ...
        AsianPutOption asianPutOption(time_steps, strike);
        BlackScholesMCPricer pricer(&asianPutOption, asset_price, interest_rate, volatility);
...
{   //Various tests
	{	
        	...
        	//testCRRPricerAmericanPutOption();
